...
import com.github.dnvriend.person.{ PersonApi, PersonCreatedCounterApi, TopicMessagePersonCreated }
import com.lightbend.lagom.scaladsl.api.ServiceCall

import scala.concurrent.{ ExecutionContext, Future }

class PersonCreatedCounter(personApi: PersonApi)(implicit ec: ExecutionContext) extends PersonCreatedCounterApi {
  // very ugly...
  var count = 0L
